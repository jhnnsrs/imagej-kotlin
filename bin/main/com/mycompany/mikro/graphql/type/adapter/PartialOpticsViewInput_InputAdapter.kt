...
import com.mycompany.mikro.graphql.type.PartialOpticsViewInput
import kotlin.IllegalStateException

public object PartialOpticsViewInput_InputAdapter : Adapter<PartialOpticsViewInput> {
  override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
      PartialOpticsViewInput = throw IllegalStateException("Input type used in output position")

  override fun toJson(
    writer: JsonWriter,
    customScalarAdapters: CustomScalarAdapters,
    `value`: PartialOpticsViewInput,
  ) {
    ...
    if (value.instrument is Optional.Present) {
      writer.name("instrument")
      NullableStringAdapter.present().toJson(writer, customScalarAdapters, value.instrument)
    }
    if (value.objective is Optional.Present) {
      writer.name("objective")
      NullableStringAdapter.present().toJson(writer, customScalarAdapters, value.objective)
    }
    if (value.camera is Optional.Present) {
      writer.name("camera")
      NullableStringAdapter.present().toJson(writer, customScalarAdapters, value.camera)
    }
  }
}
