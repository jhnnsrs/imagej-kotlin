...
import com.mycompany.mikro.graphql.type.PartialROIViewInput
import kotlin.IllegalStateException

public object PartialROIViewInput_InputAdapter : Adapter<PartialROIViewInput> {
  override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
      PartialROIViewInput = throw IllegalStateException("Input type used in output position")

  override fun toJson(
    writer: JsonWriter,
    customScalarAdapters: CustomScalarAdapters,
    `value`: PartialROIViewInput,
  ) {
    ...
    writer.name("roi")
    StringAdapter.toJson(writer, customScalarAdapters, value.roi)
  }
}
