...
import com.mycompany.mikro.graphql.type.PartialDerivedViewInput
import kotlin.IllegalStateException

public object PartialDerivedViewInput_InputAdapter : Adapter<PartialDerivedViewInput> {
  override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
      PartialDerivedViewInput = throw IllegalStateException("Input type used in output position")

  override fun toJson(
    writer: JsonWriter,
    customScalarAdapters: CustomScalarAdapters,
    `value`: PartialDerivedViewInput,
  ) {
    ...
    writer.name("originImage")
    StringAdapter.toJson(writer, customScalarAdapters, value.originImage)
  }
}
