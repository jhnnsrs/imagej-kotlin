...
import com.mycompany.mikro.graphql.type.PartialFileViewInput
import kotlin.IllegalStateException

public object PartialFileViewInput_InputAdapter : Adapter<PartialFileViewInput> {
  override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
      PartialFileViewInput = throw IllegalStateException("Input type used in output position")

  override fun toJson(
    writer: JsonWriter,
    customScalarAdapters: CustomScalarAdapters,
    `value`: PartialFileViewInput,
  ) {
    ...
    writer.name("file")
    StringAdapter.toJson(writer, customScalarAdapters, value.`file`)
    if (value.seriesIdentifier is Optional.Present) {
      writer.name("seriesIdentifier")
      NullableStringAdapter.present().toJson(writer, customScalarAdapters, value.seriesIdentifier)
    }
  }
}
