...
import com.mycompany.mikro.graphql.type.PartialAffineTransformationViewInput
import kotlin.IllegalStateException

public object PartialAffineTransformationViewInput_InputAdapter :
    Adapter<PartialAffineTransformationViewInput> {
  override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
      PartialAffineTransformationViewInput = throw
      IllegalStateException("Input type used in output position")

  override fun toJson(
    writer: JsonWriter,
    customScalarAdapters: CustomScalarAdapters,
    `value`: PartialAffineTransformationViewInput,
  ) {
    ...
    if (value.stage is Optional.Present) {
      writer.name("stage")
      NullableStringAdapter.present().toJson(writer, customScalarAdapters, value.stage)
    }
    writer.name("affineMatrix")
    AnyAdapter.toJson(writer, customScalarAdapters, value.affineMatrix)
  }
}
