...
import com.mycompany.mikro.graphql.type.PartialStructureViewInput
import kotlin.IllegalStateException

public object PartialStructureViewInput_InputAdapter : Adapter<PartialStructureViewInput> {
  override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
      PartialStructureViewInput = throw IllegalStateException("Input type used in output position")

  override fun toJson(
    writer: JsonWriter,
    customScalarAdapters: CustomScalarAdapters,
    `value`: PartialStructureViewInput,
  ) {
    ...
    AnyAdapter.toJson(writer, customScalarAdapters, value.structure)
  }
}
