...
public data class PartialTimepointViewInput(
  /**
  ...
  public val era: Optional<String?> = Optional.Absent,
  public val msSinceStart: Optional<Any?> = Optional.Absent,
  public val indexSinceStart: Optional<Int?> = Optional.Absent,
)
