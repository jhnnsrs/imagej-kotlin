...
public data class PartialPixelViewInput(
  /**
  ...
  public val linkedView: Optional<String?> = Optional.Absent,
  public val rangeLabels: Optional<List<RangePixelLabel>?> = Optional.Absent,
)
