...
public data class PartialScaleViewInput(
  /**
  ...
  public val parent: Optional<String?> = Optional.Absent,
  public val scaleX: Optional<Double?> = Optional.Absent,
  public val scaleY: Optional<Double?> = Optional.Absent,
  public val scaleZ: Optional<Double?> = Optional.Absent,
  public val scaleT: Optional<Double?> = Optional.Absent,
  public val scaleC: Optional<Double?> = Optional.Absent,
)
