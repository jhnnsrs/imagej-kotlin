...
public data class PartialOpticsViewInput(
  /**
  ...
  public val instrument: Optional<String?> = Optional.Absent,
  public val objective: Optional<String?> = Optional.Absent,
  public val camera: Optional<String?> = Optional.Absent,
)
